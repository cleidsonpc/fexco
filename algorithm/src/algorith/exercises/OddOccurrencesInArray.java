 ...
 *
 * int solution(int A[], int N); that, given an array A consisting of N integers
...
public class OddOccurrencesInArray {
	...
	public static void main(String[] args) {
		System.out.print("\nTest 1: ");
		int r1 = solution(new int[] { 9, 3, 9, 3, 9, 7, 9 });
		System.out.print(r1);

		System.out.print("\nTest 2: ");
		int r2 = solution(new int[] { 1, 1});
		System.out.print(r2);

		System.out.print("\nTest 3: ");
		int r3 = solution(new int[] { -1000, 5 });
		System.out.print(r3);
		
		System.out.print("\nTest 3: ");
		int r4 = solution(new int[] { 5 });
		System.out.print(r4);
	}
