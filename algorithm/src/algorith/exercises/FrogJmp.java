 ...
 * Write a function:
 *
 * int solution(int X, int Y, int D); that, given three integers X, Y and D,
 * returns the minimal number of jumps from position X to a position equal to or
 * greater than Y.
 *
 * For example, given:
 *
...
public class FrogJmp {
	...
	public static void main(String[] a) {
		int r = new FrogJmp().solution(10, 85, 30);
	...
	public int solution(int X, int Y, int D) {
		// int r = (int)java.lang.Math.ceil((Y - X) / (double)D);
